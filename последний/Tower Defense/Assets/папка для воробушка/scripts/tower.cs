...
public class tower : MonoBehaviour
{
    ...
    public int PowerThisTower()
    {
        ...
        int power = (int)Mathf.Round(((k-6)/16)*damage*(1f/reload)/10); //(k-6)/16 -"время атаки " (damage*(1f/reload)) - урон в секунду деление на 10 чтобы наладить размерность power-количество вносимого урона обычному крипу 
        return power;
    }
